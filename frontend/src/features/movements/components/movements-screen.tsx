...
import type { MovementsPageData, MovementsPageQuery } from "../queries";
...
export function MovementsScreen({ data, query, subtitle, title }: { data: MovementsPageData; query: MovementsPageQuery; subtitle: string; title: string }) {
  const t = useTranslations("movements");
